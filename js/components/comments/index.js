...
import { DeviceEventEmitter, Dimensions,Image, View, TouchableOpacity } from 'react-native';
                ...
                <Image source={require('../../../images/glow2.png')} style={styles.container} >
                    ...
                    <Content>
                        <View style={styles.commentHeadbg}>
                            ...
                            <Grid>
                                <Col>
                                    <Button rounded primary block  style={styles.channelBtn1}  textStyle={{fontSize: 12,fontWeight: '900',marginTop: -5}}>
                                        Best
                                    </Button>
                                </Col>
                                <Col>
